...
{
    [FormulaBase]
    public abstract class TransmissionStabilityRiskConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                CL.FormulaHelper.DTOs.CustomFieldListItemDTO p_Stability_32_Issue,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                Stability_32_Issue = p_Stability_32_Issue;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("Stability Issue")]
            [DataMember]
            public CL.FormulaHelper.DTOs.CustomFieldListItemDTO Stability_32_Issue  { get; private set; }
