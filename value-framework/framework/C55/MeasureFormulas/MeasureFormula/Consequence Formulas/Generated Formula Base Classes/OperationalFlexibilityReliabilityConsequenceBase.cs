...
{
    [FormulaBase]
    public abstract class OperationalFlexibilityReliabilityConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_Number_32_of_32_Sensitive_32_Customers,
                System.Double p_Radial_32_Load,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                Number_32_of_32_Sensitive_32_Customers = p_Number_32_of_32_Sensitive_32_Customers;
                Radial_32_Load = p_Radial_32_Load;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("Number of Sensitive Customers")]
            [DataMember]
            public System.Int32 Number_32_of_32_Sensitive_32_Customers  { get; private set; }
            
            [PromptInput("Radial Load")]
            [DataMember]
            public System.Double Radial_32_Load  { get; private set; }
