...
namespace MeasureFormulas.Generated_Formula_Base_Classes
{
    ...
    public abstract class PublicPerceptionConsequenceBase : FormulaConsequenceBase
    {
        ...
        public class TimeInvariantInputDTO
        {
            ...
            [PromptInput("Percentage Public")]
            [DataMember]
            public System.Double Percentage_32_Public  { get; private set; }
            
            [CustomFieldInput("Value of Improvement Affecting All Public", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public System.Int32? SystemValue_32_of_32_Improvement_32_Affecting_32_All_32_Public  { get; private set; }
        }
