...
{
    [FormulaBase]
    public abstract class TransmissionStationFinancialConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double? p_COF,
                CL.FormulaHelper.DTOs.CustomFieldListItemDTO p_Consequence_32_of_32_Collateral_32_Damage,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                COF = p_COF;
                Consequence_32_of_32_Collateral_32_Damage = p_Consequence_32_of_32_Collateral_32_Damage;
            ...
            [PromptInput("Consequence of Collateral Damage")]
            [DataMember]
            public CL.FormulaHelper.DTOs.CustomFieldListItemDTO Consequence_32_of_32_Collateral_32_Damage  { get; private set; }
