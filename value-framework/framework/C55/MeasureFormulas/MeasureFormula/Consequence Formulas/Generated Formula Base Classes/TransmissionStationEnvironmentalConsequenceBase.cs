...
{
    [FormulaBase]
    public abstract class TransmissionStationEnvironmentalConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double? p_COF,
                CL.FormulaHelper.DTOs.CustomFieldListItemDTO p_Consequence_32_of_32_Environment_32_Risk,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                COF = p_COF;
                Consequence_32_of_32_Environment_32_Risk = p_Consequence_32_of_32_Environment_32_Risk;
            ...
            [PromptInput("Consequence of Environment Risk")]
            [DataMember]
            public CL.FormulaHelper.DTOs.CustomFieldListItemDTO Consequence_32_of_32_Environment_32_Risk  { get; private set; }
