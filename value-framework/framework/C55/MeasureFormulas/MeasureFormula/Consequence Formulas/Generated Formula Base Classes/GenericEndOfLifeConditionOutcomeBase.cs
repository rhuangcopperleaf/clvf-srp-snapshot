...
{
    [FormulaBase]
    public abstract class GenericEndOfLifeConditionOutcomeBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            ...
            [PromptInput("Condition")]
            [DataMember]
            public System.Double Condition  { get; private set; }
