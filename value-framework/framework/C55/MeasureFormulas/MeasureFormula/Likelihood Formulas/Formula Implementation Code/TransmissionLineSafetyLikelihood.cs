...
{
    [Formula]
    public class TransmissionLineSafetyLikelihood : TransmissionLineSafetyLikelihoodBase
    {
            ...
            TimeInvariantInputDTO timeInvariantData, IReadOnlyList<TimeVariantInputDTO> timeVariantData)
        {
            ...
            var monthlyFailureProbabilities = timeInvariantData.Transmission_32_Line_32_Risk_Transmission_32_Line_32__45__32_Reliability_LikelihoodUnitOutput;
            ...
            var safetyProbablities = InterpolatePropagate<TimeVariantInputDTO>(timeVariantData, startFiscalYear, months,
                                                        (x => (((x.Probability_32_of_32_Danger ?? 0) / 100d) 
                                                            * (x.Population_32_Density != null ? x.Population_32_Density.Value : 0))));
