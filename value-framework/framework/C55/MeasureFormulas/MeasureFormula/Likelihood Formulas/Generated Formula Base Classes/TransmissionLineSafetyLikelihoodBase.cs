...
{
    [FormulaBase]
    public abstract class TransmissionLineSafetyLikelihoodBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double?[] p_Transmission_32_Line_32_Risk_Transmission_32_Line_32__45__32_Reliability_LikelihoodUnitOutput)
            {
                Transmission_32_Line_32_Risk_Transmission_32_Line_32__45__32_Reliability_LikelihoodUnitOutput = p_Transmission_32_Line_32_Risk_Transmission_32_Line_32__45__32_Reliability_LikelihoodUnitOutput;
            }
            
            [MeasureInput("Transmission Line Risk", "Transmission Line - Reliability", MeasureOutputType.LikelihoodUnitOutput, false)]
            [DataMember]
            public System.Double?[] Transmission_32_Line_32_Risk_Transmission_32_Line_32__45__32_Reliability_LikelihoodUnitOutput  { get; private set; }
        }
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double? p_COF,
                CL.FormulaHelper.DTOs.CustomFieldListItemDTO p_Population_32_Density,
                System.Double? p_Probability_32_of_32_Danger,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                COF = p_COF;
                Population_32_Density = p_Population_32_Density;
            ...
            [PromptInput("Population Density")]
            [DataMember]
            public CL.FormulaHelper.DTOs.CustomFieldListItemDTO Population_32_Density  { get; private set; }
