...
{
    [FormulaBase]
    public abstract class TransmissionElectronicReliabilityLikelihoodBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double? p_Additional_32_Failures_32_Required,
                System.Double? p_COF,
            ...
            {
                Additional_32_Failures_32_Required = p_Additional_32_Failures_32_Required;
                COF = p_COF;
            ...
            [PromptInput("Additional Failures Required")]
            [DataMember]
            public System.Double? Additional_32_Failures_32_Required  { get; private set; }
