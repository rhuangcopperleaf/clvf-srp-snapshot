    ...
    public abstract class BenefitLikelihoodBase : FormulaLikelihoodBase
    {
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double p_Benefit_32_Probability,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                Benefit_32_Probability = p_Benefit_32_Probability;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("Benefit Probability")]
            [DataMember]
            public System.Double Benefit_32_Probability  { get; private set; }
