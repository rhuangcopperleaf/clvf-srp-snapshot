...
{
    [FormulaBase]
    public abstract class TransmissionStationEnvironmentalLikelihoodBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double? p_COF,
                System.Double? p_Probability_32_of_32_Environment_32_Risk,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                COF = p_COF;
                Probability_32_of_32_Environment_32_Risk = p_Probability_32_of_32_Environment_32_Risk;
            ...
            [PromptInput("Probability of Environment Risk")]
            [DataMember]
            public System.Double? Probability_32_of_32_Environment_32_Risk  { get; private set; }
