    ...
    public abstract class RiskLikelihoodManualBase : FormulaLikelihoodBase
    {
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                CL.FormulaHelper.DTOs.NumericValueRangeDTO p_Manual_32_Risk_32_Probability,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                Manual_32_Risk_32_Probability = p_Manual_32_Risk_32_Probability;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("Manual Risk Probability")]
            [DataMember]
            public CL.FormulaHelper.DTOs.NumericValueRangeDTO Manual_32_Risk_32_Probability  { get; private set; }
