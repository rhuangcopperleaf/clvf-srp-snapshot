...
{
    [FormulaBase]
    public abstract class RiskAvoidanceLikelihoodBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double p_Risk_32_Avoidance_32_Probability,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                Risk_32_Avoidance_32_Probability = p_Risk_32_Avoidance_32_Probability;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("Risk Avoidance Probability")]
            [DataMember]
            public System.Double Risk_32_Avoidance_32_Probability  { get; private set; }
