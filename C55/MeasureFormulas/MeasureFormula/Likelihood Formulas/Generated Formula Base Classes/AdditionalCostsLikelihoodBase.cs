...
{
    [FormulaBase]
    public abstract class AdditionalCostsLikelihoodBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double p_Cost_32_Probability,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                Cost_32_Probability = p_Cost_32_Probability;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("Cost Probability")]
            [DataMember]
            public System.Double Cost_32_Probability  { get; private set; }
