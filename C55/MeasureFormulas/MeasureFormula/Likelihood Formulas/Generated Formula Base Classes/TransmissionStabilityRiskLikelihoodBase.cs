...
{
    [FormulaBase]
    public abstract class TransmissionStabilityRiskLikelihoodBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                CL.FormulaHelper.DTOs.CustomFieldListItemDTO p_Event_32_Type,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                Event_32_Type = p_Event_32_Type;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("Event Type")]
            [DataMember]
            public CL.FormulaHelper.DTOs.CustomFieldListItemDTO Event_32_Type  { get; private set; }
