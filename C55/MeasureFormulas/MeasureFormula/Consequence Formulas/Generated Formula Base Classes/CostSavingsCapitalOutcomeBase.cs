...
{
    [FormulaBase]
    public abstract class CostSavingsCapitalOutcomeBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double?[] p_Cost_32_Savings_Cost_32_Savings_32__45__32_Capital_ConsqUnitOutput_B)
            {
                Cost_32_Savings_Cost_32_Savings_32__45__32_Capital_ConsqUnitOutput_B = p_Cost_32_Savings_Cost_32_Savings_32__45__32_Capital_ConsqUnitOutput_B;
            }
            
            [MeasureInput("Cost Savings", "Cost Savings - Capital", MeasureOutputType.ConsqUnitOutput, true)]
            [DataMember]
            public System.Double?[] Cost_32_Savings_Cost_32_Savings_32__45__32_Capital_ConsqUnitOutput_B  { get; private set; }
        }
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double p_Costs_32_Saved,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                Costs_32_Saved = p_Costs_32_Saved;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("Costs Saved")]
            [DataMember]
            public System.Double Costs_32_Saved  { get; private set; }
