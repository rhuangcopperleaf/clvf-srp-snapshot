...
namespace MeasureFormulas.Generated_Formula_Base_Classes
{
    ...
    public abstract class RenewableCapacityConsequenceBase : FormulaConsequenceBase
    {
        ...
        public class TimeInvariantInputDTO
        {
            ...
            [CustomFieldInput("Renewable Capacity Value ($/MW) TimeSeries", FormulaInputAssociatedEntity.System)]
            [DataMember]
            public CL.FormulaHelper.DTOs.TimeSeriesDTO SystemRenewable_32_Capacity_32_Value_32__40__36__47_MW_41__32_TimeSeries  { get; private set; }
        }
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double p_Renewable_32_Capacity_32_Added,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                Renewable_32_Capacity_32_Added = p_Renewable_32_Capacity_32_Added;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("Renewable Capacity Added")]
            [DataMember]
            public System.Double Renewable_32_Capacity_32_Added  { get; private set; }
