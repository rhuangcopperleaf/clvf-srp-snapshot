...
{
    [FormulaBase]
    public abstract class TransmissionLineReliabilityConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double? p_COF,
                CL.FormulaHelper.DTOs.CustomFieldListItemDTO p_Line_32_Voltage,
                System.Double? p_Time_32_to_32_Repair,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                COF = p_COF;
                Line_32_Voltage = p_Line_32_Voltage;
            ...
            [PromptInput("Line Voltage")]
            [DataMember]
            public CL.FormulaHelper.DTOs.CustomFieldListItemDTO Line_32_Voltage  { get; private set; }
