...
{
    [FormulaBase]
    public abstract class TransmissionElectronicComplianceConsequenceBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double? p_NERC_32_Dollars)
            {
                NERC_32_Dollars = p_NERC_32_Dollars;
            }
            
            [PromptInput("NERC Dollars")]
            [DataMember]
            public System.Double? NERC_32_Dollars  { get; private set; }
        }
