...
{
    [Formula]
    public class TransmissionElectronicAutomaticOutcomeCondition : TransmissionElectronicAutomaticOutcomeConditionBase
    {
        public override double?[] GetUnits(int startFiscalYear, int months,
            TimeInvariantInputDTO timeInvariantData, IReadOnlyList<TimeVariantInputDTO> timeVariantData)
        {
            var estimatedDesignLifeMeasure = timeInvariantData.Transmission_32_Electronic_32_Asset_32_Risk_Transmission_32_Electronic_32__45__32_Design_32_Life_ConsqUnitOutput_B;
